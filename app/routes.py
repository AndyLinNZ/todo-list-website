...
# What happens when they click "Add new task"
# When we send requests from the client to the server, the default HTTP request is the get server. 
# If we want to send a different request, we need a different method.
# In this case, we want to send information/a method called POST
